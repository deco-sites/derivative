...
export default function ContactFormConvex({
  title = "Formulário Convex",
  description = "Formulário integrado com Convex."
}: Props) {
  ...
  const handleSubmit = async (e: Event) => {
    ...
    try {
      ...
      const result = await invoke("site/actions/contactFormConvexFixed.ts", data);
